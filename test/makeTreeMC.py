...
options['ELECTRON_CUTS']           = "(abs(superCluster.eta)<2.5) && (ecalEnergy*sin(superClusterPosition.theta)>7.0)"
...
options['SUPERCLUSTER_CUTS']       = "abs(eta)<2.5 && !(1.4442< abs(eta) <1.566) && et>7.0"
...
if (varOptions.isMC):
    options['INPUT_FILE_NAME']     = "file:/home/llr/cms/tsculac/Moriond2016/CMSSW_7_6_3/src/PhysicsTools/TagAndProbe/test/00A623C4-D1B8-E511-955B-78E7D122BCE0.root"
    ...
    options['INPUT_FILE_NAME']     = "/store/data/Run2015C_25ns/SingleElectron/MINIAOD/16Dec2015-v1/50000/34F5A66E-F4B2-E511-BDE7-0CC47A78A4A6.root"
