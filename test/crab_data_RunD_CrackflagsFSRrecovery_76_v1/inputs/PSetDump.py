...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/home/llr/cms/tsculac/Moriond2016/CMSSW_7_6_3/src/PhysicsTools/TagAndProbe/test/00050EF1-F9A6-E511-86B2-0025905A48D0.root')
)
...
process.p = cms.Path(process.hltFilter+process.ele_sequence+process.sc_sequence+process.allTagsAndProbes+process.mc_sequence+process.eleVarHelper+process.tree_sequence)
