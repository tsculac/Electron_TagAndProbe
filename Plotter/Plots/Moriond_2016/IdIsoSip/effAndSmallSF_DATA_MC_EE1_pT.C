...
// ------------>Primitives in pad: pad1
   ...
   Graph_TH1F3011->GetYaxis()->SetTitle("Efficiency");
   ...
   Graph_Graph_TH1F30113012->GetYaxis()->SetTitle("Efficiency");
   ...
   Graph_Graph3013->SetMinimum(0.71982);
   Graph_Graph3013->SetMaximum(0.96198);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Small TH1F3014->GetYaxis()->SetTitle("Scale Factor");
   ...
   Graph_Graph_Small TH1F30143015->GetYaxis()->SetTitle("Scale Factor");
