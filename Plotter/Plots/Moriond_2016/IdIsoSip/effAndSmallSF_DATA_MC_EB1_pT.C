void effAndSmallSF_DATA_MC_EB1_pT()
{
//=========Macro generated from canvas: Canvas/Canvas
//=========  (Tue Feb  9 11:58:12 2016) by ROOT version6.02/13
...
// ------------>Primitives in pad: pad1
   ...
   Graph_TH1F3001->GetYaxis()->SetTitle("Efficiency");
   ...
   Graph_Graph_TH1F30013002->GetYaxis()->SetTitle("Efficiency");
   ...
   0.0004,
   0.0008};
   grae = new TGraphAsymmErrors(6,Graph1_fx3003,Graph1_fy3003,Graph1_felx3003,Graph1_fehx3003,Graph1_fely3003,Graph1_fehy3003);
   grae->SetName("Graph1");
   ...
   Graph_Graph3003->SetMinimum(0.76168);
   Graph_Graph3003->SetMaximum(0.98152);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.63,0.35,"0.00 < |#eta| < 0.80");
tex->SetNDC();
   tex->SetTextSize(0.03);
   tex->SetLineWidth(2);
   tex->Draw();
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Small TH1F3004->GetYaxis()->SetTitle("Scale Factor");
   ...
   0.0046,
   0.0031};
   grae = new TGraphAsymmErrors(6,Graph0_fx3005,Graph0_fy3005,Graph0_felx3005,Graph0_fehx3005,Graph0_fely3005,Graph0_fehy3005);
   grae->SetName("Graph0");
   grae->SetTitle("TGraphAsymmErrors for scale factors");
   ...
   Graph_Graph_Small TH1F30043005->GetYaxis()->SetTitle("Scale Factor");
