...
// ------------>Primitives in pad: pad1
   ...
   Graph_TH1F3006->GetYaxis()->SetTitle("Efficiency");
   ...
   Graph_Graph_TH1F30063007->GetYaxis()->SetTitle("Efficiency");
   ...
   Graph_Graph3008->SetMinimum(0.76301);
   Graph_Graph3008->SetMaximum(0.96689);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Small TH1F3009->GetYaxis()->SetTitle("Scale Factor");
   ...
   Graph_Graph_Small TH1F30093010->GetYaxis()->SetTitle("Scale Factor");
