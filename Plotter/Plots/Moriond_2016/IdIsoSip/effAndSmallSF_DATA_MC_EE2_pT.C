...
// ------------>Primitives in pad: pad1
   ...
   Graph_TH1F3016->GetYaxis()->SetTitle("Efficiency");
   ...
   Graph_Graph_TH1F30163017->GetYaxis()->SetTitle("Efficiency");
   ...
   Graph_Graph3018->SetMinimum(0.72341);
   Graph_Graph3018->SetMaximum(0.92249);
...
// ------------>Primitives in pad: pad2
   ...
   Graph_Small TH1F3019->GetYaxis()->SetTitle("Scale Factor");
   ...
   Graph_Graph_Small TH1F30193020->GetYaxis()->SetTitle("Scale Factor");
