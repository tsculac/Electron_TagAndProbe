...
// ------------>Primitives in pad: pad1
   ...
   Graph_TH1F3006->GetYaxis()->SetTitle("SIP efficiency");
   ...
   Graph_Graph_TH1F30063007->GetYaxis()->SetTitle("SIP efficiency");
   ...
   Graph_Graph3008->SetMinimum(0.95499);
   Graph_Graph3008->SetMaximum(0.98991);
