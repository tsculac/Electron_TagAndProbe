...
//=========  (Mon Feb  8 16:36:24 2016) by ROOT version6.02/05
...
// ------------>Primitives in pad: pad1
   ...
   Graph_TH1F3016->GetYaxis()->SetTitle("SIP efficiency");
   ...
   Graph_Graph_TH1F30163017->GetYaxis()->SetTitle("SIP efficiency");
   ...
   Graph_Graph3018->SetMinimum(0.89328);
   Graph_Graph3018->SetMaximum(1.01952);
